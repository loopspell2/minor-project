...
const Login = ({isUserAuthenticated}) => {
    ...
    const [account, toggledAccount] = useState('login');
    ...
    const toggleSignUp = () => {
        account === 'login' ? toggledAccount('signup') : toggledAccount('login');
    }
    ...
    const signupUser = async () => {
        try {
            ...
            if (response.isSuccess) {
                ...
                showError(response.errorMessage); // Display the error message from API
            }
        } catch (error) {
